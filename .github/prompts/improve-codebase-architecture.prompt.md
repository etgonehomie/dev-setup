...
Create a refactor RFC as a GitHub issue using `gh issue create`. Use the template in **REFERENCE_FILE**. Do NOT ask the user to review before creating — just create it and share the URL.
